...
CREATE TABLE EMPLOYMENT_ADJECTIVES
(
    EMPLOYMENT_ADJECTIVES_ID INTEGER NOT NULL AUTO_INCREMENT,
    VERSION INTEGER, 
    PERSON_ID INTEGER NOT NULL,
    CONSULTANT BOOLEAN NOT NULL DEFAULT 0,
    ...
    PRIMARY KEY (EMPLOYMENT_ADJECTIVES_ID)
);
